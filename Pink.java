...
public class Pink extends Actor
{
        ...
        if(pm.dying == false){
            ...
            if(started == false && dot.dotsEaten < 30){
                ...
                if(dir == 1 && timer >= 6){  //up
                    ...
                    timer = 0;
                    setImage("tile022.png");
                }

                if(dir == 2 && timer >= 6){  //left
                    this.setLocation(this.getX() - 1, this.getY());
                    timer = 0;
                    setImage("tile020.png");
                }

                if(dir == 3 && timer >= 6){  //right
                    this.setLocation(this.getX() + 1, this.getY());
                    timer = 0;
                    setImage("tile016.png");
                }

                if(dir == 4 && timer >= 6){  //down
                    this.setLocation(this.getX(), this.getY() + 1);
                    timer = 0;
                    setImage("tile018.png");
                }
    ...
    public void start()
    {
        if((this.getX() == 18 && this.getY() == 18) || (this.getX() == 18 && this.getY() == 17) || (this.getX() == 18 && this.getY() == 16)){
            dir = 0;
            if(timer >= 6){  //up
                this.setLocation(this.getX(), this.getY() - 1);
                timer = 0;
    ...
    public void bounce()
    {
        ...
        else if(this.getX() == 18 && this.getY() == 17 ){
            if(timer >= 6){  //down
                this.setLocation(this.getX(), this.getY() + 1);
                timer = 0;
                setImage("tile018.png");
        ...
        else if(this.getX() == 18 && this.getY() == 19 ){
            if(timer >= 6){  //up
                this.setLocation(this.getX(), this.getY() - 1);
                timer = 0;
                setImage("tile022.png");
